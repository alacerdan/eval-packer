...
new function (_) {
    ...
    var Base = _9.call(Object, {
        ...
        ancestorOf: delegate(_11), extend: _9, forEach: delegate(_8), implement: function (a) {
...
with (base2.code.Colorizer) addScheme("xml", {
    ...
    tag: /(<\/?)([\w:-]+)/,
    text: /[>;][^<>&]*/
}, {cdata: IGNORE, tag: "$1@2", attribute: '@1=<span class="attribute value">$2</span>', text: IGNORE}, {tabStop: 1});
...
with (base2.code.Colorizer) addScheme("css", {
    ...
    special: /(\-[\w-]*\s*):/,
    selector: /([\w-:\[.#][^{};]*)\{/
}, {bracketed: IGNORE, selector: "@1{", special: "@1:", property: '@1:<span class="property value">$2</span>'});
